...
class ConvertRuleStringsToRuleDicts:
    """
    Converts a set of rules (each being represented in the standard ARGO string
    ...
    def __init__(self, rule_strings: dict):
        """
        Args:
    ...
    def convert(self) -> dict:
        ...
        string format) into the standard ARGO dictionary format.        

        Returns:
            dict: Set of rules defined using the standard ARGO dictionary format 
    ...
    def _convert_rule(self, rule_string: str) -> dict:
        """
        Converts a rule stored in the standard ARGO string format into the 
        standard ARGO dictionary format.
        """
    ...
    def _convert_rule_string_conditions(self, conditions_string_list: list,
                                        parent_dict: dict) -> dict:
        """
    ...
    @staticmethod
    def _find_top_level_parentheses_idx(rule_string: str) -> dict:
        """
    ...
    @staticmethod
    def _return_conditions_string_list(parentheses_pair_idxs: dict,
                                       rule_string: str) -> list:
        """
    ...
    @staticmethod
    def _find_connecting_conditions(parentheses_pair_idxs: dict,
                                    rule_string: str) -> list:
        """
    ...
    @staticmethod
    def _return_connecting_condition(connecting_cond_list: list,
                                     condition_lookup: dict) -> str:
        """
