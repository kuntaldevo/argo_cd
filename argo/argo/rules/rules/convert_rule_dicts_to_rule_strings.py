...
class ConvertRuleDictsToRuleStrings:
    """
    ...
    def convert(self, as_numpy: bool) -> dict:
        """
        Converts a set of rules (each being represented in the standard ARGO 
        dictionary format) into the standard ARGO string format.        
    ...
    def _convert_to_lambda(self, as_numpy: bool, with_kwargs: bool) -> dict:
        """
        Converts a set of rules (each being represented in the standard ARGO 
        ...
        def _make_lambda(rule_lambda_str: str, with_kwargs: bool) -> object:
    ...
    def _convert_rule(self, rule_dict: dict, as_numpy: bool) -> str:
        """
        Converts a rule stored in the standard ARGO dictionary format into the
        standard ARGO string format.
        """
    ...
    def _recurse_convert_rule_dict_conditions(self, rule_dict: dict,
    ...
    def _convert_rule_dict_conditions(self, rules_list: list, as_numpy: bool,
                                      as_lambda: bool,
                                      with_kwargs: bool) -> list:
        """
    ...
    def _create_condition_string_from_dict(self, condition_dict: dict,
                                           as_numpy: bool, as_lambda: bool,
                                           with_kwargs: bool) -> str:
    ...
    def _parse_value_lambda(self, condition_dict: dict, field: str,
                            with_kwargs: bool) -> object:
        """
    ...
    @staticmethod
    def _parse_value_string(condition_dict: dict) -> object:
        """
        Parses the values from the dictionary (depending on whether the end 
        format is the standard string format or the standard lambda expression 
        format).
